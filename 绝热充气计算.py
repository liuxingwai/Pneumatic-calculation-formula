...
# Form implementation generated from reading ui file '绝热充气计算.ui'
#
...
def sql_connection():
    try:
        # con = sqlite3.connect("绝热充气计算数据库.db")
...
def sql_table(con):
    try:
        # 创建游标
        cursor = con.cursor()
        cursor.execute("create table 绝热充气 (日期,气体类型,充气前容器中温度T1,充气后容器中温度T2,气源温度T0,充气前气体压力P1,充气后气体压力P2,等熵指数k,充气前气体质量m1,充气后气体质量m2,容器体积V,气体常数Rm)")
        # 提交事务
        con.commit()
    except Error:
        print(Error)
...
class Ui_juerechongqi(QMainWindow):
    def setupUi(self, juerechongqi):
        juerechongqi.setObjectName("juerechongqi")
        juerechongqi.setWindowModality(QtCore.Qt.NonModal)
        juerechongqi.setEnabled(True)
        juerechongqi.resize(660, 800)
        juerechongqi.setMaximumSize(QtCore.QSize(660, 800))
        font = QtGui.QFont()
        font.setFamily("楷体")
        font.setPointSize(16)
        juerechongqi.setFont(font)
        juerechongqi.setMouseTracking(False)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/PNG/chengliang.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        juerechongqi.setWindowIcon(icon)
        juerechongqi.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.label = QtWidgets.QLabel(juerechongqi)
        ...
        self.pushButton = QtWidgets.QPushButton(juerechongqi)
        ...
        self.lineEdit_2 = QtWidgets.QLineEdit(juerechongqi)
        ...
        self.lineEdit_4 = QtWidgets.QLineEdit(juerechongqi)
        ...
        self.lineEdit = QtWidgets.QLineEdit(juerechongqi)
        ...
        self.lineEdit_3 = QtWidgets.QLineEdit(juerechongqi)
        ...
        self.label_4 = QtWidgets.QLabel(juerechongqi)
        ...
        self.label_5 = QtWidgets.QLabel(juerechongqi)
        ...
        self.label_6 = QtWidgets.QLabel(juerechongqi)
        ...
        self.label_3 = QtWidgets.QLabel(juerechongqi)
        ...
        self.label_10 = QtWidgets.QLabel(juerechongqi)
        self.label_10.setGeometry(QtCore.QRect(30, 639, 601, 131))
        font = QtGui.QFont()
        font.setFamily("楷体")
        font.setPointSize(18)
        font.setKerning(True)
        ...
        self.lineEdit_5 = QtWidgets.QLineEdit(juerechongqi)
        ...
        self.label_7 = QtWidgets.QLabel(juerechongqi)
        ...
        self.lineEdit_6 = QtWidgets.QLineEdit(juerechongqi)
        ...
        self.label_8 = QtWidgets.QLabel(juerechongqi)
        ...
        self.lineEdit_7 = QtWidgets.QLineEdit(juerechongqi)
        ...
        self.label_9 = QtWidgets.QLabel(juerechongqi)
        ...
        self.lineEdit_9 = QtWidgets.QLineEdit(juerechongqi)
        ...
        self.label_11 = QtWidgets.QLabel(juerechongqi)
        ...
        self.lineEdit_8 = QtWidgets.QLineEdit(juerechongqi)
        ...
        self.label_12 = QtWidgets.QLabel(juerechongqi)
        ...
        self.comboBox = QtWidgets.QComboBox(juerechongqi)
        ...
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.label_2 = QtWidgets.QLabel(juerechongqi)
        ...
        self.lineEdit_10 = QtWidgets.QLineEdit(juerechongqi)
        ...
        self.label_13 = QtWidgets.QLabel(juerechongqi)
        ...
        self.radioButton = QtWidgets.QRadioButton(juerechongqi)
        ...
        self.radioButton_2 = QtWidgets.QRadioButton(juerechongqi)
        ...
        self.radioButton_3 = QtWidgets.QRadioButton(juerechongqi)
        self.radioButton_3.setGeometry(QtCore.QRect(590, 280, 41, 40))
        font = QtGui.QFont()
        font.setFamily("楷体")
        font.setPointSize(14)
        self.radioButton_3.setFont(font)
        self.radioButton_3.setObjectName("radioButton_3")
        self.radioButton_4 = QtWidgets.QRadioButton(juerechongqi)
        self.radioButton_4.setGeometry(QtCore.QRect(590, 330, 41, 40))
        font = QtGui.QFont()
        font.setFamily("楷体")
        font.setPointSize(14)
        ...
        self.radioButton_5 = QtWidgets.QRadioButton(juerechongqi)
        ...
        self.radioButton_6 = QtWidgets.QRadioButton(juerechongqi)
        ...
        self.radioButton_7 = QtWidgets.QRadioButton(juerechongqi)
        self.radioButton_7.setGeometry(QtCore.QRect(590, 530, 41, 40))
        font = QtGui.QFont()
        font.setFamily("楷体")
        font.setPointSize(14)
        ...
        self.retranslateUi(juerechongqi)
        QtCore.QMetaObject.connectSlotsByName(juerechongqi)
    ...
    def jisuan(self):
        global T1,  T0,  P1, P2, k, m1, m2, V, Rm, T2,T3
        T3 = 273.15
        ...
        if self.radioButton.isChecked():
            if T0==None or T0=="" or T2==None or P1==None or P2 == None or P1 == "" or P2=="" or T2=="" or k==None or k=="" or\
                ...
                k=float(k)
                T1=Symbol('T1')
                T1=solve(T2/(k*T0*T1*P2 / ((P2 - P1)*T1+k*T0*P1))-1,T1)
                print(T1)
                T1 = ','.join(str(i) for i in T1) # 取结果的数值 不是复数 且去除括号
                T1=float(T1)-T3
                self.lineEdit.setText(str(T1))
                self.qiti()
        if self.radioButton_2.isChecked():
                if T0 == None or T0 == "" or T1 == None or P1 == None or P2 == None or P1 == "" or P2 == ""\
                        or T1 == "" or k == None or k == "" or \
                        float(P2) < 0 or float(P1) < 0 or float(k) < 0:
                    QMessageBox.information(None, "提示说明", "计算数据不完整或错误，请检查后重新输入！", QMessageBox.Ok)
                else:
                    T1 = float(T1) + T3
                    ...
                    P2 = float(P2)
                    k = float(k)
                    T2 = k * T0 * T1 * P2 / ((P2 - P1) * T1 + k * T0 * P1)-T3
                    self.lineEdit_2.setText(str(T2))
                    self.qiti()
        if self.radioButton_3.isChecked():
                if T0 == None or T0 == "" or T1 == None or T2 == None or P2 == None or T2 == "" or P2 == "" \
                        or T1 == "" or k == None or k == "" or \
                    ...
                    P2 = float(P2)
                    k = float(k)
                    P1 = P2/(T2*(T1 - k*T0) / (T1*(T2 - k*T0)))
                    self.lineEdit_4.setText(str(P1))
                    self.qiti()
        if self.radioButton_4.isChecked():
            if T0 == None or T0 == "" or T1 == None or T2 == None or P1 == None or T2 == "" or P1 == "" \
                    or T1 == "" or k == None or k == "" or \
                ...
                P1 = float(P1)
                k = float(k)
                P2 = T2 * P1 * (T1 - k * T0) / (T1 * (T2 - k * T0))
                self.lineEdit_5.setText(str(P2))
                self.qiti()
        if self.radioButton_5.isChecked():
            if T2==None or T2=="" or T1 == None or P1 == None or P1 == "" or T1 == "" or k == None or k == "" or m2 == None or m2 == "" or \
                ...
                V=float(V)
                Rm=Float(Rm)
                m1=m2-V*(P2 / T2 - P1 / T1) / Rm
                self.lineEdit_7.setText(str(m1))
                self.qiti()
        if self.radioButton_6.isChecked():
            if T2==None or T2=="" or T1 == None or P1 == None or P1 == "" or T1 == "" or k == None or k == "" or m1==None or m1=="" or\
    ...
    def shuju(self):
        ...
        def sql_insert(con, data):
            cursor = con.cursor()
            cursor.execute("insert into 绝热充气 (日期,气体类型,充气前容器中温度T1,充气后容器中温度T2,气源温度T0,充气前气体压力P1,充气后气体压力P2,等熵指数k,充气前气体质量m1,充气后气体质量m2,容器体积V,气体常数Rm) values(?,?,?,?,?,?,?,?,?,?,?,?)",
                           data)
            con.commit()
        data = (now_time,A,T1,T2,T0,P1, P2, k, m1, m2, V, Rm)
        sql_insert(con, data)


    def retranslateUi(self, juerechongqi):
        _translate = QtCore.QCoreApplication.translate
        juerechongqi.setWindowTitle(_translate("juerechongqi", "绝热充气计算V1.1 By ChengLiang"))
        self.label.setText(_translate("juerechongqi", "绝热充气计算"))
        self.pushButton.setText(_translate("juerechongqi", "计算"))
        self.label_4.setText(_translate("juerechongqi", "充气后容器中温度T2（℃）"))
        self.label_5.setText(_translate("juerechongqi", "气源温度T0（℃）"))
        self.label_6.setText(_translate("juerechongqi", "充气前气体压力P1（MPa）"))
        self.label_3.setText(_translate("juerechongqi", "充气前容器中温度T1（℃）"))
        self.label_10.setText(_translate("juerechongqi", "<html><head/><body><p align=\"center\">T<span style=\" vertical-align:sub;\">2</span>=kT<span style=\" vertical-align:sub;\">0</span>T<span style=\" vertical-align:sub;\">1</span>P<span style=\" vertical-align:sub;\">2</span>/((P<span style=\" vertical-align:sub;\">2</span>-P<span style=\" vertical-align:sub;\">1</span>)T<span style=\" vertical-align:sub;\">1</span>+kT<span style=\" vertical-align:sub;\">0</span>P<span style=\" vertical-align:sub;\">1</span>)</p><p align=\"center\">P<span style=\" vertical-align:sub;\">2</span>=T<span style=\" vertical-align:sub;\">2</span>P<span style=\" vertical-align:sub;\">1</span>(T<span style=\" vertical-align:sub;\">1</span>-kT<span style=\" vertical-align:sub;\">0</span>)/(T<span style=\" vertical-align:sub;\">1</span>(T<span style=\" vertical-align:sub;\">2</span>-kT<span style=\" vertical-align:sub;\">0</span>))</p><p align=\"center\">m<span style=\" vertical-align:sub;\">2=</span>m<span style=\" vertical-align:sub;\">1</span>+V(P<span style=\" vertical-align:sub;\">2</span>/T<span style=\" vertical-align:sub;\">2</span>-P<span style=\" vertical-align:sub;\">1</span>/T<span style=\" vertical-align:sub;\">1</span>)/R<span style=\" vertical-align:sub;\">m</span></p></body></html>"))
        self.label_7.setText(_translate("juerechongqi", "充气后气体压力P2（MPa）"))
        self.label_8.setText(_translate("juerechongqi", "等熵指数k "))
        self.label_9.setText(_translate("juerechongqi", "充气后气体质量m2（g）"))
        self.label_11.setText(_translate("juerechongqi", "容器体积V（mL）"))
        self.label_12.setText(_translate("juerechongqi", "充气前气体质量m1（g）"))
        self.comboBox.setItemText(0, _translate("juerechongqi", "氦气"))
        self.comboBox.setItemText(1, _translate("juerechongqi", "氩气"))
        self.comboBox.setItemText(2, _translate("juerechongqi", "氢气"))
        self.comboBox.setItemText(3, _translate("juerechongqi", "氧气"))
        self.comboBox.setItemText(4, _translate("juerechongqi", "氮气"))
        self.comboBox.setItemText(5, _translate("juerechongqi", "二氧化碳"))
        self.comboBox.setItemText(6, _translate("juerechongqi", "空气"))
        self.label_2.setText(_translate("juerechongqi", "气体"))
        self.label_13.setText(_translate("juerechongqi", "气体常数Rm（J/kgK）"))
        self.radioButton.setText(_translate("juerechongqi", "求"))
        self.radioButton_2.setText(_translate("juerechongqi", "求"))
        self.radioButton_3.setText(_translate("juerechongqi", "求"))
        self.radioButton_4.setText(_translate("juerechongqi", "求"))
        self.radioButton_5.setText(_translate("juerechongqi", "求"))
        self.radioButton_6.setText(_translate("juerechongqi", "求"))
        self.radioButton_7.setText(_translate("juerechongqi", "求"))
import img_rc
import sys
if __name__ == '__main__':
    app = QtWidgets.QApplication(sys.argv)
    Mainwidow = QtWidgets.QMainWindow()  # 创建窗体对象
    ui = Ui_juerechongqi()  # 创建QT设计的窗体
